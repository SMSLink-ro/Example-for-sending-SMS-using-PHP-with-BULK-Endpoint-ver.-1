...
/**
 *
 *   SMS Gateway (BULK) (Version 1) integration with SMSLink.ro 
 *   
 *     using SMS Gateway (BULK) Version 1 Endpoint
 *
 *     Supports HTTP and HTTPS protocols
 *     
 *   (New) SMS Gateway (BULK) Version 3 Endpoint is available, see other examples for new features. 
 *
 *   System Requirements:
 *
 *     PHP 5+ with
 ...
 *   Usage:
 *
 *     See Usage Examples for the SMSLinkSMSGatewayBulkPackage() class starting on line 391
 *
...
{    
    ...
    protected $endpointHTTP  = "http://www.smslink.ro/sms/gateway/communicate/bulk.php";
    protected $endpointHTTPS = "https://secure.smslink.ro/sms/gateway/communicate/bulk.php";
    ...
    public function insertMessage($localMessageId, $receiverNumber, $senderId, $messageText, $timestampProgrammed = 0)
    {
        ...
        if (substr($receiverNumber, 0, 4) == "0040")                     
            $receiverNumber = substr($receiverNumber, 3);                // Converts 00407xyzzzzzz to 07xyzzzzzz
